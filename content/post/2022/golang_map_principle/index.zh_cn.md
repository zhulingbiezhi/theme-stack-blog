...
image = "http://img.ququ123.top/img/u=1862939405,1689361694&fm=253&fmt=auto&app=138&f=JPEG"
+++
...
![hashmap bmap](http://img.ququ123.top/img/57576986-acd87600-749f-11e9-8710-75e423c7efdb.png)
...
![bmap struct](http://img.ququ123.top/img/57577391-f88f1d80-74a7-11e9-893c-4783dc4fb35e.png)
...
![mapacess](http://img.ququ123.top/img/57577721-faf57580-74af-11e9-8826-aacdb34a1d2b.png)
...
![mapacess loop](http://img.ququ123.top/img/57581783-fe5c2180-74ee-11e9-99c9-5a226216e1af.png)
...
![map rehash](http://img.ququ123.top/img/57740474-af7adb80-76ea-11e9-8409-4af0ce1a814a.png)
...
![bucket split](http://img.ququ123.top/img/57818861-74df7480-77b8-11e9-8104-2a58dc006660.png)
...
![扩容前](http://img.ququ123.top/img/57963483-5b286380-7957-11e9-852a-8296c6c16daa.png)

扩容完成后，overflow bucket 消失了，key 都集中到了一个 bucket，更为紧凑了，提高了查找的效率。

![same size 扩容](http://img.ququ123.top/img/57963519-dc7ff600-7957-11e9-9877-36c3f4bc3526.png)

假设触发了 2 倍的扩容，那么扩容完成后，老 buckets 中的 key 分裂到了 2 个 新的 bucket。一个在 x part，一个在 y 的 part。依据是 hash 的 lowbits。新 map 中 `0-3` 称为 x part，`4-7` 称为 y part。

![2倍扩容](http://img.ququ123.top/img/57963651-04705900-795a-11e9-9801-e3dc475d4782.png)
...
![map iter loop](http://img.ququ123.top/img/57976471-ad2ebf00-7a13-11e9-8dd8-d7be54f96440.png)
...
![map origin](http://img.ququ123.top/img/57978113-f8a79400-7a38-11e9-8e27-3f3ba4fa557f.png)

这时，我们对此 map 进行遍历。假设经过初始化后，startBucket = 3，offset = 2。于是，遍历的起点将是 3 号 bucket 的 2 号 cell，下面这张图就是开始遍历时的状态：

![map init](http://img.ququ123.top/img/57980268-a4fa7200-7a5b-11e9-9ad1-fb2b64fe3159.png)
...
![iter res](http://img.ququ123.top/img/57980302-56010c80-7a5c-11e9-8263-c11ddcec2ecc.png)
...
![iter res](http://img.ququ123.top/img/57980349-2d2d4700-7a5d-11e9-819a-a59964f70a7c.png)
...
![iter res](http://img.ququ123.top/img/57980449-6fa35380-7a5e-11e9-9dbf-86332ea0e215.png)

和之前的流程一样，继续遍历新 1 号 bucket，发现老 1 号 bucket 已经搬迁，只用遍历新 1 号 bucket 中现有的元素就可以了。结果集变成：

![iter res](http://img.ququ123.top/img/57980487-e8a2ab00-7a5e-11e9-8e47-050437a099fc.png)

继续遍历新 2 号 bucket，它来自老 0 号 bucket，因此需要在老 0 号 bucket 中那些会裂变到新 2 号 bucket 中的 key，也就是 `lowbit == 10` 的那些 key。

这样，遍历结果集变成：

![iter res](http://img.ququ123.top/img/57980574-ae85d900-7a5f-11e9-8050-ae314a90ee05.png)
...
【面向信仰编程，golang range】[https://draveness.me/golang-for-range](https://draveness.me/golang-for-range)
