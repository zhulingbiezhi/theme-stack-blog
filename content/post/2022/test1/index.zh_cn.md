...
![anatomy_figure_1.jpg](http://img.ququ123.xyz/img/20181102210835417329515.jpg "20181102210835417329515.jpg")
...
* **TCP Flags**:TCP首部中有6个标志比特，它们中的多个可同时被设置为1，主要是用于操控TCP的状态机的，依次为URG，ACK，PSH，RST，FIN。每个标志位的意思如下：
  ...
  * **RST (Reset)－复位标志**
    ...
    ![po-1-1.png](http://img.ququ123.xyz/img/20181107144655153706648.png)
...
![TCP三次握手四次挥手过程](http://img.ququ123.xyz/img/20181105202429723374732.jpg)
...
![TCP四次握手](http://img.ququ123.xyz/img/20181105205727803473079.jpg)
...
![TCP 快启（TCP Fast Open，TFO）](http://img.ququ123.xyz/img/20200614232441828386738.png)
...
![ip数据包.png](http://img.ququ123.xyz/img/20181107200910165743028.png "20181107200910165743028.png")
...
![Screen Shot 2018-11-05 at 20.55.01.jpg](http://img.ququ123.xyz/img/20181105205714654247516.jpg "20181105205714654247516.jpg")
...
![TCP丢包机制确认](http://img.ququ123.xyz/img/20181108141614777886967.png "TCP丢包机制确认")
...
![浅析TCP之SACK](http://img.ququ123.xyz/img/20181107210526492304932.png "浅析TCP之SACK")

一个SACK的例子如下图，红框说明：接收端收到了0-5500，8000-8500，7000-7500，6000-6500的数据了，这样发送端就可以选择重传丢失的5500-6000，6500-7000，7500-8000的包。

![2.png](http://img.ququ123.xyz/img/20181107211111266586129.png "20181107211111266586129.png")
...
![](http://img.ququ123.xyz/img/20181109141324840629144.png)
...
![](http://img.ququ123.xyz/img/20181109142050297369425.png)
...
![](http://img.ququ123.xyz/img/20181109142234356704969.png)

这个时候发送方发送2个数据。 

![](http://img.ququ123.xyz/img/20181109142318634954665.png)
...
![比特滑动窗口协议](http://img.ququ123.xyz/img/20190117202326769157587.png "比特滑动窗口协议")
...
![后退n协议](http://img.ququ123.xyz/img/20190117202504418125256.png "后退n协议")
...
![选择重传协议](http://img.ququ123.xyz/img/20190117202504287130322.jpg "选择重传协议")
...
![流量控制](http://img.ququ123.xyz/img/20181108203941283550306.jpg "流量控制")
...
![TCP窗口info](http://img.ququ123.xyz/img/20181108102130221448049.png "TCP窗口info")
...
![TCP下面是个滑动后的示意图](http://img.ququ123.xyz/img/20181108111819352220086.png "TCP下面是个滑动后的示意图")

  

![](http://img.ququ123.xyz/img/20181108111819382839912.png)
...
![](http://img.ququ123.xyz/img/20181108111932276272005.png)
...
[![Silly Window Syndrome](http://img.ququ123.xyz/img/20190117204122946871903.png "Silly Window Syndrome")]
...
![](http://img.ququ123.xyz/img/20181108143850919979793.png)
...
![](http://img.ququ123.xyz/img/20181109152631995790361.png)
...
![](http://img.ququ123.xyz/img/20181109152704805846006.png)
...
![](http://img.ququ123.xyz/img/20181108191356933128233.jpg)
