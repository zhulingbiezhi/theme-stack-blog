...
[](#Very-high-level-overview)[](#very-high-level-overview)Very high level overview
----------------------------------------------------------------------------------
...
#### [](#Type-sets-of-constraints)[](#type-sets-of-constraints)Type sets of constraints
...
#### [](#Type-unification)[](#type-unification)Type unification
...
##### [](#Why-not-put-type-parameters-on-packages)[](#why-not-put-type-parameters-on-packages)Why not put type parameters on packages?
...
##### [](#Why-not-define-constraints-in-a-builtin-package)[](#why-not-define-constraints-in-a-builtin-package)Why not define constraints in a builtin package?
...
### [](#List-transform)[](#list-transform)List transform
...
### [](#Generic-type-aliases)[](#generic-type-aliases)Generic type aliases
...
### [](#Instantiating-a-function)[](#instantiating-a-function)Instantiating a function
...
### [](#Embedded-type-parameter)[](#embedded-type-parameter)Embedded type parameter
...
### [](#Embedded-type-parameter-methods)[](#embedded-type-parameter-methods)Embedded type parameter methods
...
### [](#Embedded-instantiated-type)[](#embedded-instantiated-type)Embedded instantiated type
...
### [](#Generic-types-as-type-switch-cases)[](#generic-types-as-type-switch-cases)Generic types as type switch cases
...
### [](#Method-sets-of-constraint-elements)[](#method-sets-of-constraint-elements)Method sets of constraint elements
...
### [](#Permitting-constraints-as-ordinary-interface-types)[](#permitting-constraints-as-ordinary-interface-types)Permitting constraints as ordinary interface types
...
### [](#Type-inference-for-composite-literals)[](#type-inference-for-composite-literals)Type inference for composite literals
...
### [](#Type-inference-for-generic-function-arguments)[](#type-inference-for-generic-function-arguments)Type inference for generic function arguments
...
### [](#Reflection-on-type-arguments)[](#reflection-on-type-arguments)Reflection on type arguments
