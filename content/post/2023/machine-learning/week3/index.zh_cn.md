...
![](https://img.ququ123.top/img/a77886a6eff0f20f9d909975bb69a7ab.png)

我们从二元的分类问题开始讨论。

我们将因变量(**dependent variable**)可能属于的两个类分别称为负向类（**negative class**）和正向类（**positive class**），则因变量$y \\ in { 0,1 \\ }$ ，其中 0 表示负向类，1 表示正向类。

![](https://img.ququ123.top/img/f86eacc2a74159c068e82ea267a752f7.png)

![](https://img.ququ123.top/img/e7f9a746894c4c7dfd10cfcd9c84b5f9.png)
...
![](https://img.ququ123.top/img/29c12ee079c079c6408ee032870b2683.jpg)
...
![](https://img.ququ123.top/img/d027a0612664ea460247c8637b25e306.jpg)
...
![](https://img.ququ123.top/img/1073efb17b0d053b4f9218d4393246cc.jpg)
...
![](https://img.ququ123.top/img/6590923ac94130a979a8ca1d911b68a3.png)
...
![](https://img.ququ123.top/img/58d098bbb415f2c3797a63bd870c3b8f.png)

并且参数$\theta$ 是向量[-3 1 1]。 则当$-3+{x_1}+{x_2} \geq 0$，即${x_1}+{x_2} \geq 3$时，模型将预测 $y=1$。
我们可以绘制直线${x_1}+{x_2} = 3$，这条线便是我们模型的分界线，将预测为1的区域和预测为 0的区域分隔开。

![](https://img.ququ123.top/img/f71fb6102e1ceb616314499a027336dc.jpg)

假使我们的数据呈现这样的分布情况，怎样的模型才能适合呢？

![](https://img.ququ123.top/img/197d605aa74bee1556720ea248bab182.jpg)
...
![](https://img.ququ123.top/img/f23eebddd70122ef05baa682f4d6bd0f.png)
...
![](https://img.ququ123.top/img/8b94e47b7630ac2b0bcb10d204513810.jpg)
...
![](https://img.ququ123.top/img/54249cb51f0086fa6a805291bf2639f1.png)

${h_\theta}\left( x \right)$与 $Cost\left( {h_\theta}\left( x \right),y \right)$之间的关系如下图所示：

![](https://img.ququ123.top/img/ffa56adcc217800d71afdc3e0df88378.jpg)
...
![](https://img.ququ123.top/img/eb69baa91c2fc6e7dd8ebdf6c79a6a6f.png)
...
![Want ${{\min }_\theta}J(\theta )$：](https://img.ququ123.top/img/171031235527.png)

我们要反复更新每个参数，用这个式子来更新，就是用它自己减去学习率 $\alpha$
乘以后面的微分项。求导后得到：


![Want ：](https://img.ququ123.top/img/171031235719.png)
...
所以，如果你有 $n$ 个特征，也就是说：![](https://img.ququ123.top/img/0171031235044.png)，参数向量$\theta $包括${\theta_{0}}$ ${\theta_{1}}$ ${\theta_{2}}$ 一直到${\theta_{n}}$，那么你就需要用这个式子：
...
![](https://img.ququ123.top/img/394a1d763425c4ecf12f8f98a392067f.png)
...
![](https://img.ququ123.top/img/743a769317d584a66509fc394b4e6095.png)
...
![](https://img.ququ123.top/img/bd074e119a52163691cff93c3f42a1ee.png)
...
![](https://img.ququ123.top/img/68f56679a2113c7857ab9dd2afebcba8.png)

对于一个多类分类问题，我们的数据集或许看起来像这样：

![](https://img.ququ123.top/img/54d7903564b4416305b26f6ff2e13c04.png)
...
![](https://img.ququ123.top/img/450a83c67732d254dbac2aeeb8ab910c.png)

现在我们有一个训练集，好比上图表示的有3个类别，我们用三角形表示 $y=1$，方框表示$y=2$，叉叉表示 $y=3$。我们下面要做的就是使用一个训练集，将其分成3个二元分类问题。

我们先从用三角形代表的类别1开始，实际上我们可以创建一个，新的"伪"训练集，类型2和类型3定为负类，类型1设定为正类，我们创建一个新的训练集，如下图所示的那样，我们要拟合出一个合适的分类器。

![](https://img.ququ123.top/img/b72863ce7f85cd491e5b940924ef5a5f.png)
...
![](https://img.ququ123.top/img/72f84165fbf1753cd516e65d5e91c0d3.jpg)

第一个模型是一个线性模型，欠拟合，不能很好地适应我们的训练集；第三个模型是一个四次方的模型，过于强调拟合原始数据，而丢失了算法的本质：预测新数据。我们可以看出，若给出一个新的值使之预测，它将表现的很差，是过拟合，虽然能非常好地适应我们的训练集但在新输入变量进行预测时可能会效果不好；而中间的模型似乎最合适。

分类问题中也存在这样的问题：

![](https://img.ququ123.top/img/be39b497588499d671942cc15026e4a2.jpg)
...
![](https://img.ququ123.top/img/ea76cc5394cf298f2414f230bcded0bd.jpg)
...
![](https://img.ququ123.top/img/71d723ddb5863c943fcd4e6951114ee3.png)
...
![](https://img.ququ123.top/img/2726da11c772fc58f0c85e40aaed14bd.png)
