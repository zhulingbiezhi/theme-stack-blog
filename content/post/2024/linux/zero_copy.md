...
![](http://img.ququ123.top/img/typical-memory-hierarchy.png)
...
![](http://img.ququ123.top/img/swapping-memory.png)
...
![](http://img.ququ123.top/img/virtual-memory-pages.png)
...
![](http://img.ququ123.top/img/accessing-memory-by-mmu.png)
...
![](http://img.ququ123.top/img/virtual-memory-translation.png)
...
![](http://img.ququ123.top/img/kernel-space-and-user-space.png)

## Linux I/O

### I/O 缓冲区

![](http://img.ququ123.top/img/summary-of-io-buffering.png)
...
![](http://img.ququ123.top/img/buffer-cache-page-cache.png)
...
![](http://img.ququ123.top/img/buffer-cache-in-page-cache.png)
...
![](http://img.ququ123.top/img/blocking-io-flow.png)

#### 中断驱动 I/O

第二种 I/O 模式是利用中断来实现的：

![](http://img.ququ123.top/img/linux-os-io-interrupts.png)
...
![](http://img.ququ123.top/img/linux-os-io-dma.png)
...
![](http://img.ququ123.top/img/Linux-io-read-write.png)
...
![](http://img.ququ123.top/img/linux-zero-copy-stack.png)
...
![](http://img.ququ123.top/img/Linux-io-mmap-write.png)
...
![](http://img.ququ123.top/img/Linux-io-sendfile.png)
...
![](http://img.ququ123.top/img/Linux-io-sendfile-dma-gather.png)
...
![](http://img.ququ123.top/img/pipe-buffer-underlying-impl.png)
...
pipe\_buffer 中保存了数据在内存中的页、偏移量和长度，以这三个值来定位数据，注意这里的页不是虚拟内存的页，而用的是物理内存的页框，因为管道时跨进程的信道，因此不能使用虚拟内存来表示，只能使用物理内存的页框定位数据；管道的正常读写操作是通过 pipe\_write()/pipe\_read() 来完成的，通过把数据读取/写入环形队列的 pipe\_buffer 来完成数据传输。
...
![](http://img.ququ123.top/img/linux-direct-io-by-user.png)
...
![](http://img.ququ123.top/img/linux-io-buffer-sharing-fbufs.png)
